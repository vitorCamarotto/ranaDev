...
type FontDisplay = GoogleFontsDisplay;
type FontSubset = GoogleFontsSubset;
type FontWeight = GoogleFontsWeight | string;
type FontStyle = boolean | FontWeight | FontWeight[];
type FontOptions = {
    display?: FontDisplay;
...
export { type DownloadOptions, Downloader, type DownloaderHooks, type Families, type FontDisplay, type FontInputOutput, type FontOptions, type FontStyle, type FontSubset, type FontWeight, type GoogleFonts, constructURL, download, isValidURL, merge, parse };
